...
public:
	...
	*/
	...
	/**
	@brief metodo front que te muestra 3 opciones para hacer con las series, top 3, serie hated y serie polemic y tu eliges la que quieres guardar en tu vector de busquedas
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/
	...
	*/
	...
	/**
	@brief la serie con peor valoracion en catalogo y lo guarda en el vector de busquedas del usuario
	@pre debe haber 1 serie minimo en el vector
	@pos guardara en el vector de busquedas del usuario la serie hated
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/

	void mediaHatedSerieseInsertarEnVectorDeBusquedas();
	...
	*/
	...
	void mediaPolemicSerieseInsertarEnVectorDeBusquedas();


	//TOP 3 PELICULAS

	/**
	@brief metodo front que te muestra 3 opciones para hacer con las peliculas, top 3, pelicula hated y pelicula polemic y tu eliges la que quieres guardar en tu vector de busquedas
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/
	...
	*/
	...
	/**
	@brief la pelicula con peor valoracion en catalogo y lo guarda en el vector de busquedas del usuario
	@pre debe haber 1 pelicula minimo en el vector
	@pos guardara en el vector de busquedas del usuario la pelicula hated
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/

	void mediaHatedPeliculaseInsertarEnVectorDeBusquedas();
	...
	*/
	...
	void mediaPolemicPeliculaseInsertarEnVectorDeBusquedas();

	//TOP 3 VIDEOJUEGOS

	/**
	@brief metodo front que te muestra 3 opciones para hacer con los videojuegos, top 3, videojuego hated y videojuego polemic y tu eliges la que quieres guardar en tu vector de busquedas
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/

	void top3Videojuegos();
	...
	*/
	...
	/**
	@brief el videojuego con peor valoracion en catalogo y lo guarda en el vector de busquedas del usuario
	@pre debe haber 1 videojuego minimo en el vector
	@pos guardara en el vector de busquedas del usuario el videojuego hated
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/

	void mediaHatedVideojuegoseInsertarEnVectorDeBusquedas();
	...
	*/
	...
	void mediaPolemiVideojuegoseInsertarEnVectorDeBusquedas();

	//TOP 3 CANCIONES

	/**
	@brief metodo front que te muestra 3 opciones para hacer con las canciones, top 3, cancion hated y cancion polemic y tu eliges la que quieres guardar en tu vector de busquedas
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/
	...
	*/
	...
	/**
	@brief la cancione con peor valoracion en catalogo y lo guarda en el vector de busquedas del usuario
	@pre debe haber 1 canciones minimo en el vector
	@pos guardara en el vector de busquedas del usuario la cancione hated
	@autor Raúl Ruiz Idáñez
	@ver 1.0
	*/

	void mediaHatedCancioneseInsertarEnVectorDeBusquedas();
	...
	*/
	...
	void mediaPolemicCancioneseInsertarEnVectorDeBusquedas();
